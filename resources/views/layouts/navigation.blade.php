<div style="width: 12vw;" x-data="{ open: false }"
    ...
    <div style="height: 90%; "
        ...
        <!-- Logo -->
        <a href="{{ route('dashboard') }}" class="text-white relative shrink-0 flex flex-col items-center mt-4">
        ...
        <div class="">
            <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                <div style="display: flex; gap: 5px;" class=" flex flex-col items-center">
                    <svg fill-opacity="{{ request()->routeIs('dashboard') ? 1 : 0.5 }}" width="26" height="26"
        ...
        <div class="">
            <x-nav-link :href="route('transition')" :active="request()->routeIs('transition')">
                <div style="display: flex; gap: 5px;" class="flex flex-col items-center">
                    <svg stroke-opacity="{{ request()->routeIs('transition') ? 1 : 0.5 }}" width="26" height="26"
        ...
        <div class="">
            <x-nav-link :href="route('bills')" :active="request()->routeIs('bills')">
                <div style="display: flex; gap: 5px;" class="flex flex-col items-center">
                    <svg fill-opacity="{{ request()->routeIs('bills') ? 1 : 0.5 }}" width="26" height="26"
        ...
        <div class="">
            <x-nav-link :href="route('loans')" :active="request()->routeIs('loans')">
                <div style="display: flex; gap: 5px;" class="flex flex-col items-center">
                    <svg stroke-opacity="{{ request()->routeIs('loans') ? 1 : 0.5 }}" width="26" height="26"
                        viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
        ...
        <div class="">
            <x-nav-link :href="route('crypto')" :active="request()->routeIs('crypto')">
                <div style="display: flex; gap: 5px;" class="flex flex-col items-center">
                    <svg stroke-opacity="{{ request()->routeIs('crypto') ? 1 : 0.5 }}" width="26" height="26"
                        viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
        ...
        <div class="">
            <x-nav-link :href="route('investments')" :active="request()->routeIs('investments')">
                <div style="display: flex; gap: 5px;" class="flex flex-col items-center">
                    <svg stroke-opacity="{{ request()->routeIs('investments') ? 1 : 0.5 }}" fill="none" width="26"
                        height="26" viewBox="0 0 24 24" id="up-trend-round" data-name="Flat Line"
        ...
        <div class="">
            <x-nav-link :href="route('profile.edit')" :active="request()->routeIs('profile.edit')">
                <div style="display: flex; gap: 5px;" class="flex flex-col items-center">
                    <svg stroke-opacity="{{ request()->routeIs('profile.edit') ? 1 : 0.5 }}" width="26"
