    ...
    <div style="height: 90%; "
        ...
        <div class="">
            <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                <div style="display: flex; gap: 5px;" class=" flex flex-col items-center">
                    <svg fill-opacity="{{ request()->routeIs('dashboard') ? 1 : 0.5 }}" width="30px" height="30px" viewBox="0 -0.5 21 21" version="1.1"
        ...
        <div class="">
            <x-nav-link :href="route('cards')" :active="request()->routeIs('cards')">
                <div style="display: flex; gap: 5px;" class="flex flex-col items-center">
                    <svg stroke-opacity="{{ request()->routeIs('cards') ? 1 : 0.5 }}" width="30px" height="30px" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
        ...
        <div class="">
            <x-nav-link :href="route('transition')" :active="request()->routeIs('transition')">
                <div style="display: flex; gap: 5px;" class="flex flex-col items-center">
                    <svg stroke-opacity="{{ request()->routeIs('transition') ? 1 : 0.5 }}" width="30px" height="30px" viewBox="0 0 24 24" version="1.1"
                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#ffffff">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
