<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mt-12 ">
        <div
            class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg flex p-6 {{ Auth::user()->active_cards->count() == 2 ? 'gap-2' : 'gap-20' }}">
            <div class="flex flex-col gap-8">
                <div>
                    ...
                    <div class="text-gray-900 dark:text-gray-100 ml-3 mt-1">
                        <span class="font-medium text-5xl">{{ __(Auth::user()->balance()) }}</span>
                ...
                <div class="">
                    ...
                    <div class="px-8 pb-6 text-gray-900 dark:text-gray-100 flex gap-8 flex-wrap justify-">
            ...
            <div class="flex-1 ">
                <div class="text-gray-900 dark:text-gray-100 text-lg mb-2">
                    {{ __('Quick Transfer') }}
                </div>
                ...
                <select name="card" id="card"
                    ...
                    @foreach (Auth::user()->active_cards as $card)
                        <option class="text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800"
                            value="{{ $card }}">{{ implode(' ', str_split($card->number, 4)) }}</option>
                    @endforeach
                </select>

                <x-input-label class="mt-4">{{ __('To') }}</x-input-label>
                <x-text-input id="to" class="block mt-1 w-full bg-transparent" type="number" name="to"
                    required />


                <x-input-label class="mt-4">{{ __('Amount') }}</x-input-label>
